...
public class ObavestenjeRepository {
    ...
    public final String OBAVESTENJE_COLLECTION_NAME = "/db/obavestenje";

    public boolean saveObavestenje(String documentId) {
        String collectionId = OBAVESTENJE_COLLECTION_NAME;
        Collection col = null;
        ...
        try {
            ...
            Schema schema = sf.newSchema(new File("../xml-documents/obav_v2.xsd"));
...
//            col.storeResource(res);
    ...
    public Object findObavestenje(String documentId) {
        String collectionId = OBAVESTENJE_COLLECTION_NAME;
        Collection col = null;
        XMLResource res = null;
        Object test = null;
    ...
    public void saveObavestenjeXml(String documentId, String xml) throws Exception {
        String collectionId = OBAVESTENJE_COLLECTION_NAME;
        Collection col = null;
        XMLResource res = null;
        OutputStream os = new ByteArrayOutputStream();
